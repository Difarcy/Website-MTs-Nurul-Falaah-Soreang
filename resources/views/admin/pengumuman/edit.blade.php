...
@section('content')
    <div class="space-y-6">
        ...
        <form action="{{ route('admin.pengumuman.update', $pengumuman) }}" method="POST" class="bg-white border border-gray-200 rounded-xl p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="judul" id="judul" value="{{ old('judul', $pengumuman->judul) }}" maxlength="255" required placeholder="Masukkan judul pengumuman" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-green-600 focus:border-green-600" oninput="updateCharCount('judul', 255)">
                ...
                <div>
                    ...
                    <textarea name="isi" id="isi" rows="6" maxlength="2000" required placeholder="Masukkan isi pengumuman" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-green-600 focus:border-green-600" oninput="updateCharCount('isi', 2000)">{{ old('isi', $pengumuman->isi) }}</textarea>
                    <p class="text-xs text-slate-500 mt-1 text-right">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal" value="{{ old('tanggal', $pengumuman->tanggal?->format('Y-m-d')) }}" required class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-green-600 focus:border-green-600">
            ...
            <details class="border border-gray-200 dark:border-slate-700 rounded-lg">
                ...
                <div class="px-4 pb-4 pt-2 space-y-4 border-t border-gray-200">
                    <div>
                        ...
                        <input type="number" name="urutan" value="{{ old('urutan', $pengumuman->urutan) }}" min="0" placeholder="0" class="w-full border-2 border-gray-200 rounded-lg px-4 py-2 focus:ring-2 focus:ring-green-600 focus:border-green-600">
                    ...
                    <div>
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $pengumuman->is_active) ? 'checked' : '' }} class="w-5 h-5 rounded border-gray-300 text-green-600 focus:ring-green-600">
