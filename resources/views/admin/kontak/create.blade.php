        ...
        <form action="{{ route('admin.kontak.store') }}" method="POST" class="bg-white border border-gray-200 rounded-xl p-6 space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="nilai" value="{{ old('nilai') }}" required placeholder="Masukkan nilai kontak" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-green-600 focus:border-green-600">
                ...
                <div>
                    ...
                    <input type="text" name="icon" value="{{ old('icon') }}" placeholder="Masukkan nama icon" class="w-full border-2 border-gray-200 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-green-600 focus:border-green-600">
