...
@section('title', 'Daftar - MTs Nurul Falaah Soreang')
            ...
            <div class="w-full lg:w-[40%] flex items-center justify-center p-3 sm:p-4 lg:p-5 xl:p-6 bg-gray-50 relative">
                ...
                <div class="w-full max-w-sm relative z-10">
                    ...
                    <div class="lg:hidden text-center mb-4">
                        <h1 class="text-lg font-bold text-gray-900 mb-1.5">Buat Akun Baru</h1>
                        <p class="text-sm text-gray-600">Buat akun baru untuk mengakses layanan administrasi dan informasi MTs Nurul Falaah Soreang.</p>
                    </div>

                    <!-- Header Desktop -->
                    <div class="hidden lg:block mb-4 text-center">
                        <h1 class="text-xl font-bold text-gray-900 mb-1.5">Buat Akun Baru</h1>
                        <p class="text-sm text-gray-600 leading-relaxed">
                            Buat akun baru untuk mengakses layanan administrasi dan informasi MTs Nurul Falaah Soreang.
                        </p>
                    </div>
                    ...
                    <div class="space-y-4">
                        @if ($errors->any())
                            <div class="bg-red-50 border border-red-200 text-red-700 text-xs px-3 py-2 rounded">
                                {{ $errors->first() }}
                            </div>
                        @endif
                        <!-- Register via Google -->
                        ...
                        <form action="{{ route('register.store') }}" method="POST" class="space-y-4">
                            ...
                            <div class="flex items-start">
                                <input type="checkbox" id="terms" name="terms" value="1" class="mt-1 w-4 h-4 text-green-700 border-gray-300 rounded focus:ring-green-700" @checked(old('terms'))>
                                <label for="terms" class="ml-2 text-xs text-gray-600">
                                    Saya menyetujui
                                    <a href="#" class="text-green-700 hover:text-green-800 font-semibold">Syarat & Ketentuan</a>
                                    dan
                                    <a href="#" class="text-green-700 hover:text-green-800 font-semibold">Kebijakan Privasi</a>
                                </label>
                            </div>
                        ...
                        <div class="text-center">
                            <p class="text-sm text-gray-600">
                                Sudah punya akun?
                                <a href="{{ route('login') }}" class="text-green-700 hover:text-green-800 font-semibold transition-colors">
                                    Masuk sekarang
                                </a>
                            </p>
                        </div>
